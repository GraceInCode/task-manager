            ...
            <div className="w-full max-w-lg">
                ...
                <div className="mb-12 transform -rotate-1">
                    <div className="flex items-end space-x-4 mb-6">
                        ...
                        <div>
                            <h1 className="font-display text-5xl font-bold text-charcoal leading-none mb-2">Welcome back</h1>
                            <p className="font-mono text-rust text-sm tracking-wide">// authenticate.user()</p>
                        </div>
                    </div>
                </div>
